"""
      task7_1.py   -   Using the logging Module
      ...
      This exercise uses another module (logging.py) to configure
      and set up a logger.  The logger will be implemented as a
      decorator and used to decorate the get_location() method of the
      starter file.
"""
import sqlite3
